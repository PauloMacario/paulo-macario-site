            ...
            <div class="card">
                <div class="card card-lightblue mb-0">
                    <div class="card-header">
                        <h5 class="card-title">Novo Investimento</h5>
                    </div>
                    <div class="card-body">                      
                        <form action="{{ route('investmentsCreate_post') }}" method="POST" id="form">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xs-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input 
                                                ...
                                                name="name" 
                                                id="name"
                                                placeholder="XPTO11, PETR4, etc..."
                                                required
                                            >                          
                                        </div>       
                                        
                                        <div class="form-group">
                                            <label for="segment_id">Tipo de seguimento</label>
                                            <select 
                                                class="form-control form-control-sm" 
                                                name="segment_id" 
                                                id="segment_id" 
