            ...
            <div class="card">
                <div class="card card-lightblue mb-0">
                    <div class="card-header">
                        <h5 class="card-title">Detalhes do Seguimento: <strong>{{ $segment->name }}</strong></h5>
                    </div>
                    <div class="card-body">                      
                        <form action="{{ route('segmentsUpdate_post') }}" method="POST" id="form">
                            @csrf
                                            ...
                                            <select 
                                                ...
                                                @foreach ($typeInvestments as $type)
                                                    <option value="{{ $type->id }}"
                                                            ...
                                                            @if($type->id == $segment->type_investment_id) selected  @endif
                                                        >
                                                        {{ $type->name }}
                                                    </option>
                                                @endforeach
