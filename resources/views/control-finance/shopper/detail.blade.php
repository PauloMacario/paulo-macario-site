            ...
            <div class="card">
                <div class="card card-olive mb-0">
                    <div class="card-header">
                        <h5 class="card-title">Detalhes do(a) Comprador(a): <strong>{{ $shopper->name }}</strong></h5>
                    </div>
                    <div class="card-body">                      
                        <form action="{{ route('updateShopper_post') }}" method="POST" id="form">
                            @csrf
                                    ...
                                    <div class="col-xs-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <select 
                                                ...
                                                id="status"
                                                >
                                                <option value="D" @if($shopper->status  == 'D') selected @endif>Desativado</option>                                 
                                                <option value="E" @if($shopper->status  == 'E') selected @endif>Ativo</option>
                                            </select>                                        
                                        </div>
